...
branches, bark and foliage.

**The shipped value is assumed, unverified.** No value the upstream
workbook has carried for these rows has a citation that can be opened:
the beech anchor's source cell begins `ChatGPT.`, the conifer anchor's
two citations do not resolve as written, and the holm-oak anchor's cell
is blank (whep#932). The anchors can still be placed against an
independent compilation. Thurner et al. (2025) pool 1048 stem, 599
branch, 267 root and 5944 leaf nitrogen measurements for boreal and
temperate trees – the woody ones almost entirely from 192 literature
studies – and report medians, in kg N per kg dry matter, of 0.0010 in
stem sapwood, 0.0035 in branches, 0.0060 in roots and 0.0167 in leaves.
Against those, `Average wood`'s 0.0030 is 0.86 of the branch median and
3.0 times the stem median – a branch concentration – while the retired
pin's 0.00095 is 0.95 of the stem median, a stemwood one.
...
whichever single number the cell carries is wrong by about that factor
for one of its two uses. The same ordering appears in the
trembling-aspen budget of Morrison and Foster (1979, reproduced in
...
temperate tree tissues vary with tree age/size, growth rate, and
