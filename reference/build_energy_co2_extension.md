...
choice is recorded in `method_energy`. A meat group with carcass output
but no slaughtered-head counts keeps its energy CO2e, split equally
across the group's live-animal sectors, and triggers a warning.
