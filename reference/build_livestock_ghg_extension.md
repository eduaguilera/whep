...
- `2`: Tier 2 cohort energy balance (IPCC 2019). It derives enteric CH4
  ...
  dropped with a warning rather than entering the footprint as `NA`.
  **Tier 2 is not yet calibrated** – its enteric CH4 currently runs well
  above Tier 1 – so Tier 1 is the recommended default until the Tier 2
