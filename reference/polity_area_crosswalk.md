...
Sudan combined, and **it is a gap in the bucket vocabulary rather than
in `area_code`**. FAOSTAT stops reporting area 206 in 2011 and does not
...
column in which to say "bucket 206 from 2012 answers as
`F206-2011-2025`", which is why
[`polity_bucket_coverage()`](https://eduaguilera.github.io/whep/reference/polity_bucket_coverage.md)
still labels that bucket `SUD-1956-2011` / `"out_of_span"` for 2012
onward – a polity that ended in 2011. Expressing it is \#742 and
labelling it is \#860; neither is decided here.
