...
#> 3  0.75  0.25         1          2511  2010     200           120       40
#> 4  0.75  0.25         1          2555  2010      40             4        6
#> 5 10.2   5.25         2          2511  2010      80            30       12
#> 6 10.2   5.25         2          2513  2010      60             8        6
#> 7 10.8   5.25         2          2555  2010      20             8        3
#> # ℹ 10 more variables: used_residue_n_t <dbl>, grazed_weeds_n_t <dbl>,
...
#> 4  0.75  0.25         1          2555  2010      40             120
#> 5 10.2   5.25         2          2511  2010      80              50
#> 6 10.2   5.25         2          2513  2010      60              50
#> 7 10.8   5.25         2          2555  2010      20             100
#> # ℹ 11 more variables: actual_kgn_ha <dbl>, exceed_share <dbl>,
...
#> # A tibble: 6 × 10
#>   area_code item_cbs_code  year exceedance_n_t within_boundary_n_t actual_n_t
#>       <int>         <int> <int>          <dbl>               <dbl>      <dbl>
#> 1         1          2511  2010             58                  29         87
#> 2         1          2513  2010              0                   1          1
#> 3         1          2555  2010              0                   0          0
#> 4         2          2511  2010             11                   4         15
#> 5         2          2513  2010              0                   1          1
#> 6         2          2555  2010              2                   2          4
#> # ℹ 4 more variables: production_n_t <dbl>, metric <chr>, land_use <chr>,
#> #   method_boundary <chr>
#> 
#> 
#> $boundary_pathway
...
#> 4  0.75  0.25         1          2555  2010      40                  25
#> 5 10.2   5.25         2          2511  2010      80                  20
#> 6 10.2   5.25         2          2513  2010      60                  20
#> 7 10.8   5.25         2          2555  2010      20                  15
...
#>   <int>     <int>             <dbl>               <dbl>      <dbl>
#> 1  2010         1              59.9               1380. 4000000000
#> 2  2010         2              89.3               2069. 3000000000
#> # ℹ 3 more variables: method_food_supply <chr>, value_norm <dbl>, nourish <chr>
#> 
#> $scatter
#> # A tibble: 2 × 5
