...
| `WHEP_LUH2_DIR` | `read_luh2_landuse()` | LUH2 directory with the gridded `states.nc` product (Hurtt et al. 2020). The base v2h release covers 850-2015; the annually-updated Global Carbon Budget variants extend further, so check `states.nc`'s own time axis rather than assuming 2015. |
