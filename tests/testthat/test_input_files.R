testthat::test_that(".find_cache_dir correctly locates cached files", {
...
testthat::test_that(".pins_cache_base returns existing directory", {
...
testthat::test_that("whep_read_file falls back to cache when remote unreachable", {
