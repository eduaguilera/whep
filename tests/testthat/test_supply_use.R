...
testthat::test_that(
  ".build_processing gives supply use table for processed items",
  {
...
testthat::test_that(
  ".build_use_husbandry gives feed intake needs for animal husbandry",
  {
...
testthat::test_that(
  ".build_supply_husbandry gives livestock and their products",
  {
...
testthat::test_that(
  ".build_use_crop_production gives seed use for crop production",
  {
