...
testthat::test_that("an aggregate with a bucket but no polity is dropped", {
  ...
  # rather than a territory. It holds on the real pins too: exactly in 64 of
  # the 67 raw (area, year) rows, and off by ten persons in the other three
  # (2015, 2016 and 2020 in `faostat-fbs-new`, which publishes the item in
  # thousands), a maximum of 7e-7 per cent.
