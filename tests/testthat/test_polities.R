test_that("add_polity_code maps area codes by year", {
  ...
  expect_equal(mapped$polity_code[6], "BLX-1800-2025")
  expect_equal(mapped$polity_code[7], "RAFR-1800-2025")
  expect_equal(mapped$polity_code[8], "ROW-1800-2025")
})
...
test_that("get_polity_geometries returns requested polygon rows", {
  ...
  expect_equal(
    ...
    c("AFG-1919-2025", "NCL-1800-2025", "ROW-1800-2025")
  )
