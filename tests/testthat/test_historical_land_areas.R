...
# validity interval. `NEW` holds cell A over two successive intervals carrying
# the SAME geometry, which is what reducing the support to one weight per cell
# has to survive.
.two_cell_support <- function() {
  tibble::tribble(
    ...
    "OLD",        1L,       0.25, 0.25, 1L,          3L,        100,             100,           0,                0,
    "NEW",        1L,       0.25, 0.25, 3L,          5L,        100,             100,           0,                0,
    "NEW",        1L,       0.25, 0.25, 5L,          9L,        100,             100,           0,                0,
    "NEW",        2L,       0.75, 0.25, 3L,          9L,        100,             100,           0,                0
  )
}
...
test_that("the cell cover is read off the polycell support", {
  ...
  # The weight is the polity's whole TERRITORY in the cell, not its land.
