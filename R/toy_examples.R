...
.example_gridded_livestock_emissions <- function() {
  tibble::tribble(
    ...
    dplyr::mutate(
      ...
      method_manure_ch4 = "IPCC_2019_Tier2; climate_from_data",
