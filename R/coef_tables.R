...
#' The long `bnf_provenance` sidecar records cell-level evidence for every
#' non-missing numeric value in `bnf`; it documents the runtime table but does
#' not replace it as a coefficient input.
#'
#' @param name Coefficient table name (the file stem), for example
#'   `"bio_coefs"`, `"bnf"` or `"bnf_provenance"`.
