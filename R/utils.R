...
utils::globalVariables(
  c(
    ...
    "unit_desc",
    "value_unit",
    # admin_stats_eurostat.R (#1000) — Eurostat SDMX-CSV columns and reader intermediates
    "conf_status",
    "geo",
    "geo_class",
    "item_raw",
    ...
    "to_whep",
    "vintage_rank",
    # admin_stats_sidra.R (#1000) — IBGE SIDRA JSON fields and reader intermediates
    "sidra_unit_code",
    "source_native_item_code",
    "source_native_unit_id",
    "unit_code",
    "unit_label",
    "variable_code",
    # spatialize_levels.R (#1000) — level-aware country grid and allocation layer
    "cell_land_ha",
    "container_area_code",
    "container_code",
    "container_land_ha",
    ...
    "admin",
    "subnational",
    # admin_shares_seam.R (#1000) — seam back-cast, unit extents and zero-case counters
    ".cell_value",
    ".direct",
    ".extent_t0",
    ".filled",
    ...
    "treatment",
    "treatment_year",
    # admin_shares_resolve.R (#1000) — source-precedence resolver
    "candidate_rank",
    "forced",
    "forced_source",
    "forced_source_all",
...
#   exists",
    ...
    "glw_code",
    "glw_species",
    # spatialize_levels.R (#1000, T13) — two-level crop allocation: unit
    # targets, the residual pseudo-unit, coverage, breach and straddle tables
    "admin_sum",
    "allocated_ha",
    "basis",
    "candidate",
    ...
    "weight_irrigated",
    "weight_rainfed",
    # spatialize.R (#1000, T13) — the unit multicropping ceiling inside the
    # engine; `i.` names are data.table join-side columns
    "i.unit_mc_ir",
    "i.unit_mc_rf",
    "ir_share",
    "rf_share",
    ...
    "unit_rf",
    "unit_rf_land",
    # admin_shares_gate.R (#1000, T29b) — the tier-B hold-out leg
    "anchor_year",
    "n_units_gated",
    "share_backcast",
    "share_observed",
    # admin_reconcile.R (#1000, T14) — reconciliation diagnostics; the
    # columns it shares with spatialize_levels.R are declared above
    "area_share_renorm",
    "area_sum",
    "beyond_tolerance",
    "breach_national_ha",
